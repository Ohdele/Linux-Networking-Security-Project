...
Configure the server's private network interface to use a static IP address, which is essential for consistent firewall application and service management.
